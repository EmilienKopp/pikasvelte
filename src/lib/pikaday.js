 ...
 */
const hasEventListeners = typeof window !== 'undefined' && !!window.addEventListener;

const document = typeof window !== 'undefined' ? window.document : null;

const sto = typeof window !== 'undefined' ? window.setTimeout : setTimeout;
...
function isoWeek(date, firstWeekOfYearMinDays) {
...
function renderWeek(d, m, y, firstWeekOfYearMinDays) {
...
function renderTitle(instance, c, year, month, refYear, randId) {
    let i,
        j,
        arr;
    ...
    let html = '<div id="' + randId + '" class="pika-title" role="heading" aria-live="polite">',
        monthHtml,
        yearHtml,
        prev = true,
        next = true;
